...
VL_INLINE_OPT void VCPU_MMIO___nba_sequent__TOP__CPU__memory_inst__mmio_inst__0(VCPU_MMIO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VCPU_MMIO___nba_sequent__TOP__CPU__memory_inst__mmio_inst__0\n"); );
    ...
    if (vlSymsp->TOP.rst) {
        ...
        if ((0xffffff0cU == vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr)) {
            vlSelfRef.__PVT__Led1 = (0xffU & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemWriteData);
        }
        if ((0xffffff0cU != vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr)) {
            if ((0xffffff10U == vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr)) {
                vlSelfRef.__PVT__Led2 = (0xffU & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemWriteData);
            }
            if ((0xffffff10U != vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr)) {
                if ((0xffffff28U == vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr)) {
                    vlSelfRef.__PVT__Seg1 = vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemWriteData;
                }
            }
        }
    }
...
VL_INLINE_OPT void VCPU_MMIO___nba_sequent__TOP__CPU__memory_inst__mmio_inst__1(VCPU_MMIO* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VCPU_MMIO___nba_sequent__TOP__CPU__memory_inst__mmio_inst__1\n"); );
    VCPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    } else if ((0xffffeU == (vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr 
                             >> 0xcU))) {
        vlSelfRef.__Vlvbound_h37617fa1__0 = (0xffU 
                                             & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemWriteData);
        if ((0xbffU >= (0xfffU & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr))) {
            __VdlyVal__chars__v1 = vlSelfRef.__Vlvbound_h37617fa1__0;
            __VdlyDim0__chars__v1 = (0xfffU & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr);
            vlSelfRef.__VdlyCommitQueuechars.enqueue(__VdlyVal__chars__v1, (IData)(__VdlyDim0__chars__v1));
        }
    } else if ((0xffffdU == (vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr 
                             >> 0xcU))) {
        vlSelfRef.__Vlvbound_h45e5c314__0 = (0xffU 
                                             & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemWriteData);
        if ((0xbffU >= (0xfffU & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr))) {
            __VdlyVal__color__v1 = vlSelfRef.__Vlvbound_h45e5c314__0;
            __VdlyDim0__color__v1 = (0xfffU & vlSymsp->TOP__CPU__mem_stage__U_DCache.__PVT__MemAddr);
