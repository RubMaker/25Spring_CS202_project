...
VL_ATTR_COLD void VCPU_Mux2___ctor_var_reset(VCPU_Mux2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VCPU_Mux2___ctor_var_reset\n"); );
    VCPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const uint64_t __VscopeHash = VL_HASH(vlSelf->name());
    vlSelf->__PVT__Select = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16914479330164474878ull);
