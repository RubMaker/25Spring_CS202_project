...
#endif
            VL_FATAL_MT("../CPU.sv", 22, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../CPU.sv", 22, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../CPU.sv", 22, "", "Active region did not converge.");
            }
